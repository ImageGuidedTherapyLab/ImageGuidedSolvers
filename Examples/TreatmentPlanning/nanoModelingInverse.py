...
# should be in meters
AffineTransform.Translate([-0.004,0.008,-0.001])
...
nsubstep = 1
acquisitionTime = 4.66
deltat = acquisitionTime / nsubstep
ntime  = 60 
fem.AddPennesSystem(2,deltat,nsubstep,[ [4,40,ntime],[0.0,1.0,0.0] ]) 
