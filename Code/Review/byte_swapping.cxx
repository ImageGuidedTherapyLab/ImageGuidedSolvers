...
#include <assert.h>
extern "C" void FORTRAN_NAME(swapbyteorderf90)(float *,int *);


// use float datatype for both reals and integers in fortran
void FORTRAN_NAME(swapbyteorderf90)(float* input, int *num)
{
	unsigned int c;
	for (c=0; c<*num; c++) {
